  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.inner}>
        <div>
          <h2 className={styles.footerLogo}>BOLAGINAM</h2>
          <p className={styles.footerTagline}>Bolalar quvonchini uyingizga olib kelamiz</p>
        </div>
        <div>
          <h3 className={styles.footerHeading}>Aloqa</h3>
          <p className={styles.footerLink}>+998 90 123 45 67</p>
          <p className={styles.footerLink}>info@bolaginam.uz</p>
          <p className={styles.footerLink}>Toshkent sh.</p>
        </div>
        <div>
      ...
      <div className={styles.bottom}>
        <span>© {currentYear} BOLAGINAM. Barcha huquqlar himoyalangan.</span>
